  ...
  return (
    <div className='project-box'>
      <div className='project-title'>
        ...
        {
          github ? 
          <a className='title-link' href={github} target='_blank'>
        ...
        {
          link ? 
          <a className='title-link' style={{textDecoration:'None', color:'black'}} href={link} target='_blank'>
      ...
      <div className='project-content'>
        {imgname ? 
            <a href={imgname.src} target="_blank" rel="noreferrer" style={{display:'inline'}}>
                <Image id='projectimg' width={250} height={0} style={{height:'auto'}} alt='project image' src={imgname}/>
            </a> : null
        }
